<template>
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            ...
            <h3 class="text-white">Akbar Ginanjar</h3>
            </router-link>

            <div class="row" slot="content-header" slot-scope="{closeMenu}">
                <div class="col-6 collapse-brand">
            <h4>Akbar Ginanjar</h4>
                </div>
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <base-dropdown tag="li" class="nav-item">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">Hari 5 <i class="fa fa-angle-down ml-1"></i></span>
                    </a>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.facebook.com/akbar.ginanjar.961" target="_blank" rel="noopener"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.instagram.com/akbarginanjar_"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://twitter.com/akbarginanjarr_" target="_blank" rel="noopener"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://github.com/akbarginanjar"
